...
#define STRING_CONFIG_H_AUTHOR "(Chris Jones, AM8)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "David's AM8"
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                32 // LED driving pin
